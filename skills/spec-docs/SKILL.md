...
Block candidates: repair edits business code without request; update silently weakens architecture rules; architecture rules weakened without ADR/confirmation; completion claimed without impact-appropriate spec action after implementation-relevant changes.
